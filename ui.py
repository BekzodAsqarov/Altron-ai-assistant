...
class JarvisUI:
    ...
    def _draw(self):
        ...
        c.create_text(W // 2, H - 14, fill=C_DIM, font=("Courier", 8),
                      text="FatihMakes Industries  ·  CLASSIFIED  ·  MARK I")
    ...
    def write_log(self, text: str):
        ...
        elif tl.startswith("altron:") or tl.startswith("ai:"):
    ...
    def _show_setup_ui(self):
        ...
        tk.Label(
            self.setup_frame,
            text="Configure ALTRON before first boot.",
            fg=C_MID, bg="#00080d",
            font=("Courier", 9)
        ).pack(pady=(0, 14))
    ...
    def _save_api_keys(self):
        ...
        self.set_state("LISTENING")
        self.write_log(f"SYS: Systems initialised. OS → {os_system.upper()}. Altron online.")